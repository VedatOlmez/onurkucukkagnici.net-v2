...
const JournalTemplate = props => {
  ...
  return (
    <>
      <SEO title="DT. Onur Küçükkağnıcı | Konya Ortodonti, Konya Ortodonti Fiyatları, Konya Ortodonti Tedavisi, Konya Şeffaf Plak, Konya Şeffaf Plak Tedavisi" />
      <h1>BLOG</h1>
      <p>
        {" "}
        Konya Ortodonti hakkında daha fazla bilgi için blog yazılarımızı okuyabilirisiniz.
      </p>
      {edges.map(({ node }) => (
        <BlogItem
